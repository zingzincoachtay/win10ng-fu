...
set targetfollder="\\hagcsv005\PURCHASING\02 QUOTES\02 MOLDED PART Suppliers"
...
C:\Users\kaoki\Documents\md5deep-4.4\md5deep64.exe -r %targetfollder% | sort /+35 > %Qtwo%
echo ...Done
)
